...
#
# DONE: Define a hopping window of 1 minute with a 10-second step
...
uri_summary_table = uri_summary_table.hopping(size=timedelta(minutes=1), step=timedelta(seconds=10))
