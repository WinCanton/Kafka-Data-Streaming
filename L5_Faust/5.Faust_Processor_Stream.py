...
#
# DONE: Define a scoring function for incoming ClickEvents.
...
def add_score(clickevent):
    clickevent.score = random.randint(1,100) * clickevent.number
    return clickevent
...
async def clickevent(clickevents):
    #
    # DONE: Add the `add_score` processor to the incoming clickevents
