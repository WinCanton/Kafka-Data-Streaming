...
def produce():
    ...
    # DONE: Set the appropriate headers
    #       See: https://docs.confluent.io/current/kafka-rest/api.html#content-types
    headers = {"Content-Type": "application/vnd.kafka.json.v2+json"}
    # DONE: Define the JSON Payload to be sent to REST Proxy
    ...
    # DONE: What URL should be used?
    #       See: https://docs.confluent.io/current/kafka-rest/api.html#post--topics-(string-topic_name)
    resp = requests.post(
        f"{REST_PROXY_URL}/topics/lesson4.exercise5", data=json.dumps(data), headers=headers  # DONE
    )
