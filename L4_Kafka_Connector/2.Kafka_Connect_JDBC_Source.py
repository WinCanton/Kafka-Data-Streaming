...
def configure_connector():
    ...
    #
    # DONE: Complete the Kafka Connect Config below for a JDBC source connector.
    ...
    resp = rest_method(
        ...
        data=json.dumps(
            {
                "name": "clicks-jdbc",  # DONE.
                "config": {
                    "connector.class" : "io.confluent.connect.jdbc.JdbcSourceConnector",
                    "topic.prefix": "connect-",  # DONE
                    "mode": "incrementing",  # DONE 
                    "incrementing.column.name": "id",  # DONE
                    "table.whitelist": "click",  # DONE
                    "tasks.max": 1,
